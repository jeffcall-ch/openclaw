...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "browser.proxyServer": "Browser Proxy Server",
  "browser.lang": "Browser Language",
  "browser.acceptLanguage": "Browser Accept-Language",
  "browser.timezoneId": "Browser Timezone",
